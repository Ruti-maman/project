...
const AgentPage = observer(() => {
  ...
  const myTickets = ticketStore.tickets.filter(
    (t: any) =>
      t.agent_id === authStore.user?.id || t.agent?.id === authStore.user?.id
  );
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ fontSize: 32, color: "#2c3e50", letterSpacing: 1 }}>
          לוח בקרה לנציג
        </h1>
        <button
      ...
      <button
        onClick={() => ticketStore.fetchTickets()}
        style={{
          background: "#007bff",
          color: "white",
          border: "none",
      ...
      >
        ...
        >
          <thead>
            <tr style={{ background: "#3498db", color: "white" }}>
              ...
              <th style={{ padding: 12, borderRadius: "0 8px 0 0" }}>
                פרטי טיקט / תגובות
              </th>
            </tr>
          </thead>
                ...
                <td style={{ padding: 12 }}>
                  <span
                    style={{
                      ...
                      borderRadius: 6,
                      background:
                        t.status === "3" || t.status_id === 3
                          ? "#e74c3c"
                          : t.status === "2" || t.status_id === 2
                          ? "#f1c40f"
                          : "#2ecc71",
                      color: "white",
                      fontWeight: "bold",
                ...
                <td style={{ padding: 12 }}>
                  ...
                  >
                    ...
                    <button
                      ...
                      disabled={
                        loadingComment[t.id] ||
                        !(commentText[t.id] && commentText[t.id].trim())
                      }
                      style={{
                        background: "#2ecc71",
                        color: "white",
        ...
        {myTickets.length === 0 && (
          ...
          >
            אין טיקטים שמוקצים אליך.
            <br />
            אם אין טיקטים, בקש מהמנהל להקצות אליך טיקט!
          </div>
        )}
      </div>
    </div>
